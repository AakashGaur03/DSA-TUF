...
int maxPath(TreeNode *root, int &maxi) {
  ...
  // We have done max 0 and other so that if there is negative then
  // ignore those childrens
  // Refer 7_L17_Maximum_Path_Sum_in_Binary_Tree_1  &
  // 7_L17_Maximum_Path_Sum_in_Binary_Tree_2
...
int main() {
  cout << "7 L17 Maximum Path Sum in Binary Tree" << endl;
