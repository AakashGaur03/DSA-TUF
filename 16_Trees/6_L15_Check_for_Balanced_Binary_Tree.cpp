...
bool optimizedBalancedBinaryTree(TreeNode *root) {
  // means we didnt got -1 from any height diff and it is a balanced Binary Tree
  return dfsHeight(root) != -1;
}

int main() {
  cout << "6 L15 Check for Balanced Binary Tree" << endl;
  // Balanced Binary Tree means for every node, height(left) - height(right) <=1
  // Refer 6_L15_Check_for_Balanced_Binary_Tree_1
